...
insert into Employees VALUES(2,'Adrian','Matta','adrianmatta@me.com','C');
insert into loginemployee values(1,1,'adrian','adrian');
insert into loginemployee values(2,2,'maros','maros');
